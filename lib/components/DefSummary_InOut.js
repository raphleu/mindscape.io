...
var DefSummary = function (_React$Component) {
  _inherits(DefSummary, _React$Component);

  function DefSummary(props) {
    _classCallCheck(this, DefSummary);

    var _this = _possibleConstructorReturn(this, (DefSummary.__proto__ || Object.getPrototypeOf(DefSummary)).call(this, props));

    _this.handleClick = _this.handleClick.bind(_this);
    return _this;
  }

  _createClass(DefSummary, [{
    key: 'handleClick',
...
export var DefSummary_InOut = connect(function (state, ownProps) {
  ...
  while (partner_path_node_id !== user_id) {
    Object.keys(link_by_id_by_end_id[partner_path_node_id]).some(function (link_id) {
      ...
      if (link.properties.user_id === user_id && link.properties.hide_vect.length === 0 && // not hidden/deleted
